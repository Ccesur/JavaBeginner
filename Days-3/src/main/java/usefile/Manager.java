...
public class Manager {
    ...
    public void createFile() {
        try {
            ...
            System.err.println("createFile" + ex.getMessage());
        }
    }
    ...
    public void addLine(String line) {
        try {
            ...
            FileWriter fileWriter = new FileWriter (file,true); //append dosya içindekileri koru yeni yaz
